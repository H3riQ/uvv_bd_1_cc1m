...
/* Dando os privilégios para o usuário henrique */
GRANT ALL ON *.* TO henrique;

/* Saindo para logar com o usuário criado */
EXIT
...
ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'Chave primária importada da tabela regiões.';
...
ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'Chave primária importada da tabela países.';
...
ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'Chave primária importada da tabela localizacoes.';
...
ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'ual do empregado.';
...
ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'do).';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'epartamento atual de um empregado.';
...
ALTER TABLE gerentes COMMENT 'Tabela relacionando os gerentes com departamentos.';

ALTER TABLE gerentes MODIFY COLUMN id_gerente INTEGER COMMENT 'Chave primária importada da tabela empragado.';

ALTER TABLE gerentes MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave primária importada da tabela departamento.';
...
ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'a empregados.';
...
ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'rgo em que o empregado estava trabalhando no passado.';
