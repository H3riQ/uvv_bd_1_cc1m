...
COMMENT ON TABLE hr.regioes IS 'Tabela regiões. Contém os números e nomes das regiões.';
...
COMMENT ON COLUMN hr.paises.id_regiao IS 'Chave primária importada da tabela regiões.';
...
COMMENT ON COLUMN hr.localizacoes.id_pais IS 'Chave primária importada da tabela países.';
...
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'Chave primária importada da tabela localizacoes.';
...
COMMENT ON COLUMN hr.empregados.id_cargo IS 'Chave primária importada da tabela cargos. Indica o cargo atual do empregado.';
...
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'Chave estrangeira para a própria tabela empregados (auto-relacionamento).
Indica o supervisor direto do empregado (pode corresponder ou não ao manager_id
do departamento do empregado).';
COMMENT ON COLUMN hr.empregados.id_departamento IS 'Chave primária importada da tabela departamentos. Indica o departamento atual de um empregado.';
...
COMMENT ON TABLE hr.gerentes IS 'Tabela relacionando os gerentes com departamentos.';
COMMENT ON COLUMN hr.gerentes.id_gerente IS 'Chave primária importada da tabela empragado.';
COMMENT ON COLUMN hr.gerentes.id_departamento IS 'Chave primária importada da tabela departamento.';
...
antiga do empregado.';
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'Parte da chave primária composta da tabela (empregado_id e data_inicial).
Também é uma chave primária importada da tabela empregados.';
...
COMMENT ON COLUMN hr.historico_cargos.id_cargo IS 'Chave primária importada da tabela cargos. Corresponde ao cargo em que o empregado estava trabalhando no passado.';
COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'Chave primária importada da tabela departamentos. Corresponde ao departamento em que o empregado estava trabalhando no passado.';
...
/* Inserindo os dados na tabela gerentes */
